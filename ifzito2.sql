...
--
-- Host: 127.0.0.1
-- Tempo de geração: 19/08/2026 às 22:23
...
CREATE TABLE `disciplina` (
  `id_disciplina` bigint NOT NULL,
  `nome_disciplina` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `estudantes` (`id_estudante`, `fotoEstudante`, `nomeEstudante`, `dataNascimentoEstudante`, `cursoEstudante`, `emailEstudante`, `senhaEstudante`, `pronome`) VALUES
(1, 'img/37f24020d9dd8ba1bec78a95aea974da.jpg', 'Teste', '2026-08-04', 'TECINF', 'teste@gmail.com', '202cb962ac59075b964b07152d234b70', NULL),
(2, 'img/pv-2.webp', 'laurinha', '2026-08-11', 'TECINF', 'lau@gmail.com', '202cb962ac59075b964b07152d234b70', NULL),
(3, 'img/uall.png', 'ana', '3999-09-12', 'TECINF', 'ana@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', NULL);
...
CREATE TABLE `tarefas` (
  ...
  `descricaoTarefa` varchar(500) DEFAULT NULL,
  `id_materia` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
--
ALTER TABLE `curso_disciplina`
  MODIFY `id_curso_disciplina` bigint NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tarefas`
  ADD CONSTRAINT `tarefas_ibfk_1` FOREIGN KEY (`id_materia`) REFERENCES `materias` (`id_materia`);
COMMIT;
